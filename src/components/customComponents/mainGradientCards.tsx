...
//   },
// ];
const bgGradientArray: string[] = [
  "bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-700", // Classic blue
  "bg-gradient-to-br from-emerald-500 to-green-600", // Fresh green
  "bg-gradient-to-br from-rose-500 to-pink-600", // Soft rose
  "bg-gradient-to-br from-purple-500 to-indigo-600", // Royal purple
  "bg-gradient-to-br from-red-500 to-orange-600", // Energetic red-orange
  "bg-gradient-to-br from-yellow-500 to-orange-600", // Warm sunset
  "bg-gradient-to-br from-cyan-500 to-blue-600", // Calm aqua
  "bg-gradient-to-br from-slate-500 to-gray-700", // Neutral professional
  "bg-gradient-to-br from-teal-500 to-emerald-600", // Modern teal
  "bg-gradient-to-br from-fuchsia-500 to-purple-600", // Vibrant but stylish
];

const mainGradientCards = ({stats}: any) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
      {stats.map((stat, index) => (
        ...
        >
          <div className={`p-6 ${bgGradientArray[index % 10]} text-white relative overflow-hidden group`}>
...
export default mainGradientCards