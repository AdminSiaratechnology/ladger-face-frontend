...
const GodownRegistration: React.FC = () => {
  ...
  const stats = useMemo(() => ({
    ...
    activeGodowns: statusFilter === 'active' ? pagination?.total : filteredGodowns?.filter(g => g.status === 'active').length || 0,
    totalCapacity: filteredGodowns?.reduce((sum, godown) => sum + (parseInt(godown.capacity) || 0), 0) || 0
  ...
  const headers=["Godown", "Location", "Capacity", "Manager", "Status", "Actions"];
        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {filteredGodowns.map((godown) => (
              <tr key={godown._id} className="hover:bg-gray-50 transition-colors duration-200">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <CheckAccess module="InventoryManagement" subModule="Godown" type="edit">
                    <ActionsDropdown
  ...
  const CardView = () => (
    <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
      {filteredGodowns?.map((godown: Godown) => (
        <Card key={godown._id} className="bg-white border-0 shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl overflow-hidden group">
          ...
          <CardContent className="p-6 space-y-4">
            ...
            <div className="pt-3 border-t border-gray-100">
              <div className="flex items-center text-sm">
                ...
                <span className="text-gray-600">Created: {new Date(godown.createdAt).toLocaleDateString()}</span>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <Card className="bg-gradient-to-br from-teal-500 to-teal-600 text-white border-0 shadow-lg">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-teal-100 text-sm font-medium">Total Godowns</p>
                <p className="text-3xl font-bold">{stats.totalGodowns}</p>
              </div>
              <Warehouse className="w-8 h-8 text-teal-200" />
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-blue-500 to-blue-600 text-white border-0 shadow-lg">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-blue-100 text-sm font-medium">Primary Godowns</p>
        ...
        <Card className="bg-gradient-to-br from-green-500 to-green-600 text-white border-0 shadow-lg">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-green-100 text-sm font-medium">Active Godowns</p>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                  <div className="flex flex-col gap-1">
                    <label className="text-sm font-semibold text-gray-700">Parent Godown</label>
                    <select
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-2 text-sm text-gray-600">
                    ...
                    <p><strong>Parent:</strong> {formData.parent === 'primary' ? 'None' : formData.parent}</p>
                    <p><strong>Company:</strong> {companies.find(c => c._id === formData.company)?.namePrint || 'Not specified'}</p>
                  </div>
                </div>
