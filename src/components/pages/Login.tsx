...
export default function Login() {
  ...
  const { fetchCompanies, companies, defaultSelected } = useCompanyStore();
                  ...
                  <div className="hidden md:grid grid-cols-2 gap-4 mb-8">
                    <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/20 transition-all duration-300">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-xs text-emerald-200 bg-emerald-400/20 px-2 py-1 rounded-full">
                          +12%
                        </span>
                      </div>
                    ...
                    <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/20 transition-all duration-300">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-xs text-amber-200 bg-amber-400/20 px-2 py-1 rounded-full">
                          +8%
                        </span>
                      </div>
                    ...
                    <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/20 transition-all duration-300">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-xs text-green-200 bg-green-400/20 px-2 py-1 rounded-full">
                          Online
                        </span>
                      </div>
                    ...
                    <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/20 transition-all duration-300">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-xs text-blue-200 bg-blue-400/20 px-2 py-1 rounded-full">
                          -2%
                        </span>
                      </div>
                ...
                <TabsContent value="email" className="space-y-4 md:space-y-6">
                  <div className="space-y-4 md:space-y-6">
                    <div>
                      <Label
                        htmlFor="email"
                        className="text-slate-700 mb-2 md:mb-3 block font-medium text-sm md:text-base"
                      >
                        Email Address
                      </Label>
                    ...
                    <div className="text-right">
                      <button
                        className="text-xs md:text-sm bg-gradient-to-r from-teal-600 to-indigo-600 bg-clip-text text-transparent hover:from-teal-700 hover:to-indigo-700 hover:underline transition-all duration-200 font-medium"
                        type="button"
                      >
