    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-4">
      <div className="w-full max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="hidden sm:block bg-gradient-to-br from-teal-600 via-indigo-600 to-indigo-700 p-4 md:p-10 relative overflow-hidden">
            {/* Decorative Elements */}
            ...
            <div className="relative z-10 h-full flex flex-col">
              ...
              <div className="flex items-center mb-4 md:mb-8">
                <div className="w-8 md:w-12 h-8 md:h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center mr-4 border border-white/30">
                  <Building className="w-5 md:w-7 h-5 md:h-7 text-white" />
                </div>
                <div>
                  <h1 className="text-xl md:text-2xl font-bold text-white">Ledger Face</h1>
                  <p className="text-white/80 text-xs md:text-sm">Business Management</p>
                </div>
              </div>
              ...
              <div className="flex-1">
                ...
                <p className="text-white/90 mb-4 md:mb-8 text-sm md:text-lg">
                ...
                <div className="hidden md:block space-y-2 md:space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-white text-sm md:text-base">Real-time Analytics Dashboard</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center border border-white/30">
                      <Shield className="w-4 h-4 text-white" />
                    </div>
                    <span className="text-white text-sm md:text-base">Multi-role Access Control</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center border border-white/30">
                      <TrendingUp className="w-4 h-4 text-white" />
                    </div>
                    <span className="text-white text-sm md:text-base">Advanced Business Intelligence</span>
                  </div>
                </div>
              </div>
          ...
          <div className="p-4 md:p-10 flex flex-col justify-center bg-white">
            <div className="mb-4 md:mb-8">
              <h1 className="text-2xl md:text-3xl font-bold text-slate-800 mb-2">Welcome Back</h1>
              <p className="text-slate-600 text-sm md:text-base">Access your business management dashboard</p>
            </div>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="email" className="space-y-4 md:space-y-6">
                <div className="space-y-4 md:space-y-6">
                  <div>
                    <Label htmlFor="email" className="text-slate-700 mb-2 md:mb-3 block font-medium text-sm md:text-base">Email Address</Label>
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="pl-12 h-12 md:h-14 bg-slate-50 border-slate-200 focus:border-transparent focus:ring-2 focus:ring-gradient-to-r focus:from-teal-600 focus:to-indigo-600 focus:bg-white transition-all duration-200 rounded-xl"
                        style={{
                  ...
                  <div>
                    <Label htmlFor="password" className="text-slate-700 mb-2 md:mb-3 block font-medium text-sm md:text-base">Password</Label>
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="pl-12 pr-12 h-12 md:h-14 bg-slate-50 border-slate-200 focus:border-transparent focus:ring-2 focus:bg-white transition-all duration-200 rounded-xl"
                        style={{
                          '--tw-ring-color': 'transparent',
                          '--tw-ring-offset-shadow': '0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color)',
                          '--tw-ring-shadow': 'inset 0 0 0 1px rgb(15 118 110 / 0.5), 0 0 0 calc(2px + var(--tw-ring-offset-width)) rgb(79 70 229 / 0.3)'
                  ...
                  <div className="text-right">
                    <button className="text-xs md:text-sm bg-gradient-to-r from-teal-600 to-indigo-600 bg-clip-text text-transparent hover:from-teal-700 hover:to-indigo-700 hover:underline transition-all duration-200 font-medium" type="button">
                      Forgot your password?
                    </button>
                  </div>
                  <Button 
                    onClick={handleEmailLogin}
                    className="w-full h-12 md:h-14 bg-gradient-to-r from-teal-600 to-indigo-600 hover:from-teal-700 hover:to-indigo-700 text-white flex items-center justify-center gap-2 rounded-xl font-semibold transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5" 
                    disabled={loading}
                  >
              ...
              <TabsContent value="otp" className="space-y-4 md:space-y-6">
                <div className="space-y-4 md:space-y-6">
                  <div>
                    <Label htmlFor="phone" className="text-slate-700 mb-2 md:mb-3 block font-medium text-sm md:text-base">Phone Number</Label>
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="pl-12 h-12 md:h-14 bg-slate-50 border-slate-200 focus:border-transparent focus:ring-2 focus:bg-white transition-all duration-200 rounded-xl"
                        style={{
                          '--tw-ring-color': 'transparent',
                          '--tw-ring-offset-shadow': '0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color)',
                          '--tw-ring-shadow': 'inset 0 0 0 1px rgb(15 118 110 / 0.5), 0 0 0 calc(2px + var(--tw-ring-offset-width)) rgb(79 70 229 / 0.3)'
                  ...
                  <Button 
                    type="button" 
                    variant="outline" 
                    className="w-full h-10 md:h-12 border-slate-200 bg-gradient-to-r from-teal-600 to-indigo-600 bg-clip-text text-transparent hover:from-teal-700 hover:to-indigo-700 hover:bg-slate-50 transition-all duration-200 rounded-xl border-2 hover:border-slate-300"
                  >
                    Send OTP Code
                  </Button>
                  <div>
                    <Label htmlFor="otp" className="text-slate-700 mb-2 md:mb-3 block font-medium text-sm md:text-base">Verification Code</Label>
                    <Input
                      id="otp"
                      type="text"
                      ...
                      maxLength={6}
                      className="h-12 md:h-14 bg-slate-50 border-slate-200 focus:border-transparent focus:ring-2 focus:bg-white text-center text-lg tracking-widest transition-all duration-200 rounded-xl"
                      style={{
                        '--tw-ring-color': 'transparent',
                        '--tw-ring-offset-shadow': '0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color)',
                        '--tw-ring-shadow': 'inset 0 0 0 1px rgb(15 118 110 / 0.5), 0 0 0 calc(2px + var(--tw-ring-offset-width)) rgb(79 70 229 / 0.3)'
              ...
              <TabsContent value="social" className="space-y-4 md:space-y-6">
                <Button
                  type="button"
                  variant="outline"
                  className="w-full h-12 md:h-14 border-slate-200 text-slate-700 flex items-center justify-center gap-3 hover:bg-slate-50 hover:border-slate-300 transition-all duration-200 rounded-xl border-2"
                  onClick={handleGoogleLogin}
                >
                  <svg className="w-5 md:w-6 h-5 md:h-6" viewBox="0 0 24 24">
                    <path fill="currentColor" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                    <path fill="currentColor" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
                    <path fill="currentColor" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/>
                    <path fill="currentColor" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/>
              ...
              <TabsContent value="biometric" className="space-y-4 md:space-y-6">
                <div className="text-center py-4 md:py-8">
                  <div className="inline-flex items-center justify-center w-16 md:w-20 h-16 md:h-20 bg-gradient-to-br from-teal-100 via-indigo-100 to-indigo-200 rounded-2xl mb-4 md:mb-6 relative">
                    <div className="absolute inset-0 bg-gradient-to-br from-teal-600/10 to-indigo-600/10 rounded-2xl"></div>
                    <Fingerprint className="w-8 md:w-10 h-8 md:h-10 bg-gradient-to-r from-teal-600 to-indigo-600 bg-clip-text text-transparent relative z-10" />
                  </div>
                  <h3 className="text-base md:text-lg font-semibold text-slate-800 mb-2">Biometric Authentication</h3>
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    className="w-full h-12 md:h-14 border-slate-200 bg-gradient-to-r from-teal-600 to-indigo-600 bg-clip-text text-transparent hover:from-teal-700 hover:to-indigo-700 hover:bg-slate-50 transition-all duration-200 rounded-xl font-semibold border-2 hover:border-slate-300"
            ...
            <div className="mt-4 md:mt-8 p-4 bg-gradient-to-r from-slate-50 to-slate-100 rounded-xl border border-slate-200">
